...
void ssd1306_display_text(SSD1306_t *dev, int page, int seg, const char *text, int text_len, bool invert);
...
void spi_master_init(SSD1306_t *dev, int16_t GPIO_MOSI, int16_t GPIO_SCLK, int16_t GPIO_CS, int16_t GPIO_DC,
                     int16_t GPIO_RESET);
